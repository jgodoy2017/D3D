...
*/
	...
	//cout<<maximo_<<endl;
	 ...
	 int suma=0;
	 for (int k=0;k<cantidad_imagenes;k++){

	 ifstream in2(images[k].path.c_str(), std::ifstream::ate | std::ifstream::binary);
	 ...
	 float ratio = float(in1.tellg())/float(suma);
	 cout<<"nmax= "<<nmax<<" entrada: "<< suma<<" salida: "<< in1.tellg()<<" ratio: "<< ratio<<endl;
